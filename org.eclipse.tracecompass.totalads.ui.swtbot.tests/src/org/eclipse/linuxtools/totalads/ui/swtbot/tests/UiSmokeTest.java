...
package org.eclipse.linuxtools.totalads.ui.swtbot.tests;
...
public class UiSmokeTest extends AbstractUiTest {
    ...
    public void testDiagnosis() {
        ...
        bot.radio("Select the Trace Selected in TMF (Only Kernel Trace)").click();
    ...
    public void testLiveMonitor() {
        SWTBotPreferences.KEYBOARD_LAYOUT = "EN_US";
        SWTBotView botView = new SWTBotView(getViewPartRef("LiveMonitor"), fBot);
        assertNotNull(botView);
        botView.setFocus();
