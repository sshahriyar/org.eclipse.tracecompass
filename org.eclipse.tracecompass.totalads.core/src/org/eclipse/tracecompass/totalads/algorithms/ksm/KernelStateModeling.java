...
import org.eclipse.tracecompass.totalads.algorithms.ksm.Messages;
import org.eclipse.tracecompass.totalads.algorithms.ksm.SettingsCollections;
import org.eclipse.tracecompass.totalads.algorithms.ksm.TraceCollection;
    ...
    private void measureStateProbabilities(ITraceIterator trace, TraceStates states, IAlgorithmOutStream out) throws TotalADSGeneralException, TotalADSReaderException {
        ...
        while (trace.advance()) {
            ...
            if (sysCount % 100000 == 0) {
                out.addOutputEvent("Executing " + sysCount + Messages.KernelStateModeling_ExecuteSpecific); //$NON-NLS-1$
                out.addNewLine();
            }
